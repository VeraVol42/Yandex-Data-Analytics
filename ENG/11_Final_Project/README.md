...
#### 🔍 Key Tasks:
- Cohort analysis (examining the behavior of user groups over time)  
- User segmentation (grouping users by activity, region, etc.)  
- Visualization of user paths (Sankey diagram)  
...
#### 🔍 Key Tasks:
- Retrieving, cleaning, and aggregating data from a database  
- Working with multiple tables, using JOIN, GROUP BY, and subqueries  
